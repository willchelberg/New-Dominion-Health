...
export declare function collectMigrationMutations(
  ...
  documents: () => AsyncIterableIterator<SanityDocument_2>,
  context: MigrationContext,
): AsyncGenerator<Mutation | Transaction | (Mutation | Transaction)[], any, any>
...
export declare function dryRun(
  ...
  migration: Migration,
): AsyncGenerator<Mutation | Transaction | (Mutation | Transaction)[], void, any>
 ...
 * @public
 */
export declare type NormalizeReadOnlyArray<T> = T extends readonly [infer NP, ...infer Rest]
  ? [NP, ...Rest]
...
export declare function replace<
  ...
  ReferenceItem extends IndexedSegment | KeyedSegment,
>(items: ArrayElement<Items> | Items, referenceItem: ReferenceItem): ReplaceOp<Items, ReferenceItem>
