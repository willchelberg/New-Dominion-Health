...
function DocumentPaneProvider(props) {
  ...
  let t48;
  $[218] !== onProgrammaticFocus ? (t48 = /* @__PURE__ */ jsx(DivergenceAutofocus, { onProgrammaticFocus }), $[218] = onProgrammaticFocus, $[219] = t48) : t48 = $[219];
  let t49;
  $[220] !== children || $[221] !== documentId || $[222] !== editState_1 || $[223] !== formState || $[224] !== t48 || $[225] !== upstreamEditState_0 || $[226] !== value_0._id ? (t49 = /* @__PURE__ */ jsxs(DivergencesProvider, { upstreamEditState: upstreamEditState_0, editState: editState_1, subjectId: documentId, schemaType: formState.schemaType, displayedId: value_0._id, formState, children: [
    t48,
    children
  ] }), $[220] = children, $[221] = documentId, $[222] = editState_1, $[223] = formState, $[224] = t48, $[225] = upstreamEditState_0, $[226] = value_0._id, $[227] = t49) : t49 = $[227];
  let t50;
  $[228] !== documentPane || $[229] !== t49 ? (t50 = /* @__PURE__ */ jsx(DocumentPaneContext.Provider, { value: documentPane, children: t49 }), $[228] = documentPane, $[229] = t49, $[230] = t50) : t50 = $[230];
  let t51;
  return $[231] !== documentPaneInfo || $[232] !== t50 ? (t51 = /* @__PURE__ */ jsx(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t50 }), $[231] = documentPaneInfo, $[232] = t50, $[233] = t51) : t51 = $[233], t51;
}
...
const DivergenceAutofocus = (t0) => {
  const $ = c(7), {
    onProgrammaticFocus
  } = t0, divergenceNavigator = useDocumentDivergences();
  let t1;
  $[0] !== divergenceNavigator.state.focusedDivergence || $[1] !== onProgrammaticFocus ? (t1 = () => {
    typeof divergenceNavigator.state.focusedDivergence < "u" && onProgrammaticFocus(fromString(divergenceNavigator.state.focusedDivergence));
  }, $[0] = divergenceNavigator.state.focusedDivergence, $[1] = onProgrammaticFocus, $[2] = t1) : t1 = $[2];
  const focusDivergentPath = useEffectEvent(t1);
  let t2;
  $[3] !== focusDivergentPath ? (t2 = () => {
    focusDivergentPath();
  }, $[3] = focusDivergentPath, $[4] = t2) : t2 = $[4];
  let t3;
  return $[5] !== divergenceNavigator.state.focusedDivergence ? (t3 = [divergenceNavigator.state.focusedDivergence], $[5] = divergenceNavigator.state.focusedDivergence, $[6] = t3) : t3 = $[6], useEffect(t2, t3), null;
